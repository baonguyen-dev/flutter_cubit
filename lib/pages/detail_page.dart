                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 5,),
                              AppText(text: "USA, Columbia", color: AppColors.textColor1,)
                            ],
                          ),
                          SizedBox(height: 20,),
                          Row(
                            children: [
                              Wrap(
                                children: List.generate(5, (index){
                                  return Icon(Icons.star, color:index<4?AppColors.starColor:AppColors.textColor2);
                                }),
                              ),
                              SizedBox(width: 10,),
                          ...
                          SizedBox(height: 10,),
                          AppText(text: "Description", color:AppColors.mainTextColor),
                        ],
                      ),
                    ),
                  )),
